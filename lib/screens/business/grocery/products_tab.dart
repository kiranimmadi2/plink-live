...
/// Tab for managing grocery products
/// Note: Reuses retail infrastructure since data models are identical
class GroceryProductsTab extends StatefulWidget {
  ...
  @override
  State<GroceryProductsTab> createState() => _GroceryProductsTabState();
}

class _GroceryProductsTabState extends State<GroceryProductsTab> {
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  _terminology?.filter1Label ?? 'Groceries',
                  style: TextStyle(
                    fontSize: 24,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(
              noProductsAtAll ? Icons.shopping_basket_rounded : Icons.search_off_rounded,
              size: 64,
