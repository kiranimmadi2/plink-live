...
export 'templates/restaurant_template.dart';
export 'templates/salon_template.dart';
export 'templates/healthcare_template.dart';
export 'templates/hotel_template.dart';
export 'templates/real_estate_template.dart';
export 'templates/retail_template.dart';
export 'templates/fitness_template.dart';
export 'templates/education_template.dart';
