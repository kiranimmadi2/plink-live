...
import 'templates/salon_template.dart';
import 'templates/healthcare_template.dart';
import 'templates/hotel_template.dart';
import 'templates/real_estate_template.dart';
import 'templates/retail_template.dart';
import 'templates/fitness_template.dart';
import 'templates/education_template.dart';
  ...
  Widget _buildTemplate(BusinessModel business, CategoryProfileConfig config) {
    switch (business.category) {
      case BusinessCategory.foodBeverage:
        return RestaurantTemplate(business: business, config: config);

      case BusinessCategory.beautyWellness:
        return SalonTemplate(business: business, config: config);

      case BusinessCategory.healthcare:
        return HealthcareTemplate(business: business, config: config);

      case BusinessCategory.hospitality:
        return HotelTemplate(business: business, config: config);

      case BusinessCategory.realEstate:
        return RealEstateTemplate(business: business, config: config);

      case BusinessCategory.retail:
      case BusinessCategory.grocery:
        return RetailTemplate(business: business, config: config);

      case BusinessCategory.fitness:
        return FitnessTemplate(business: business, config: config);

      case BusinessCategory.education:
        return EducationTemplate(business: business, config: config);

      default:
        // Use generic template for all other categories
