      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Add your courses and classes to start accepting student enrollments',
                  ...
                  if (course.image != null)
                    ClipRRect(
                      ...
                      child: Image.network(
                        ...
                        height: 120,
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => _buildIconPlaceholder(categoryColor),
                      ),
                    )
                  else
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'e.g., Python Programming, Guitar Basics',
                    ...
                    // Mode
                    _buildSectionTitle('Mode', isDarkMode),
                    const SizedBox(height: 8),
                    Wrap(
                      spacing: 8,
