...
class _AppointmentsTabState extends State<AppointmentsTab> {
  ...
  Widget _buildCalendarSection(bool isDarkMode) {
    return AnimatedContainer(
      ...
      height: _isCalendarExpanded ? 320 : 80,
  ...
  Widget _buildEmptyState(bool isDarkMode) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.only(left: 40, right: 40, top: 40, bottom: 100),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Container(
            ...
            const SizedBox(height: 8),
            Text(
              'No appointments scheduled for ${_getFormattedDate(_selectedDate)}',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
                color: isDarkMode ? Colors.white54 : Colors.grey[600],
