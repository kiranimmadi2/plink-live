...
class _LiveConnectTabScreenState extends ConsumerState<LiveConnectTabScreen> {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Row(
              children: [
                Icon(Icons.error_outline, color: AppColors.textPrimaryDark),
                SizedBox(width: 12),
                Expanded(
                  child: Text(
  ...
  void _showMyProfile() {
    ...
    showModalBottomSheet(
      ...
      backgroundColor: AppColors.backgroundDark.withAlpha(0),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    height: 4,
                    decoration: BoxDecoration(
                      color: AppColors.greyTint(alpha: 0.6),
                              ...
                              children: [
                                ...
                                SliderTheme(
                                  data: SliderThemeData(
                                    ...
                                    thumbColor: AppColors.vibrantGreen,
                                    overlayColor: AppColors.vibrantGreen
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(
                                          Icons.info_outline,
                                          size: 14,
                                          color: AppColors.greyTint(alpha: 0.7),
                                        ),
                              ...
                              children: _availableGenders.map((gender) {
                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: isSelected
                                          ? AppColors.professional.withValues(
                                              alpha: 0.2,
                                            )
                                          : AppColors.backgroundDarkTertiary,
                                      borderRadius: BorderRadius.circular(20),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: AppColors.blackAlpha(alpha: 0.1),
                          blurRadius: 12,
  ...
  List<Color> _getAvatarGradient(String name) {
    ...
    switch (hash) {
      case 0:
        return [AppColors.vibrantPink, AppColors.gradientPinkDark]; // Pink
      case 1:
        return [AppColors.professional, AppColors.gradientBlueDark]; // Blue
      case 2:
        return [
      ...
      case 3:
        return [
          AppColors.vibrantPurple,
          AppColors.gradientPurpleDark,
        ]; // Purple
      default:
        return [AppColors.vibrantGreen, AppColors.gradientGreenDark]; // Green
    }
  }
  ...
  Color _getInterestTagColor(String interest, int index) {
    return AppColors.interestTagColors[index %
        AppColors.interestTagColors.length];
  }
  ...
  Future<void> _toggleFavorite(String userId, String userName) async {
    ...
    try {
      ...
      final favoriteUsers = List<String>.from(
        userDoc.data()?['favoriteUsers'] ?? [],
      );
          ...
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              backgroundColor: isGlass
                  ? AppColors.whiteAlpha(alpha: 0.7)
                  : (isDarkMode
                        ? AppColors.blackAlpha(alpha: 0.9)
                        : AppColors.whiteAlpha(alpha: 0.95)),
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: isGlass
                    ? [
                        AppColors.lightBlueTint.withValues(alpha: 0.8),
                        AppColors.lightPurpleTint.withValues(alpha: 0.6),
                        AppColors.lightGreenTint.withValues(alpha: 0.4),
                        AppColors.lightOrangeTint.withValues(alpha: 0.3),
                      ]
                    : isDarkMode
                    ? [
                    ...
                    children: [
                        ...
                        child: FilterChip(
                          label: const Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 3),
                              Text('Near Me', style: AppTextStyles.caption),
                            ],
                          ),
                      ...
                      Padding(
                        ...
                        child: FilterChip(
                          ...
                          selectedColor: AppColors.vibrantPink,
                          checkmarkColor: Colors.white,
                          visualDensity: VisualDensity.compact,
                          materialTapTargetSize:
                              MaterialTapTargetSize.shrinkWrap,
                      ...
                      Padding(
                        ...
                        child: FilterChip(
                          ...
                          selectedColor: AppColors.vibrantBlue,
                          checkmarkColor: Colors.white,
                          visualDensity: VisualDensity.compact,
                          materialTapTargetSize:
                              MaterialTapTargetSize.shrinkWrap,
                      ...
                      Padding(
                        ...
                        child: FilterChip(
                          ...
                          selectedColor: AppColors.vibrantYellow,
                          checkmarkColor: Colors.white,
                          visualDensity: VisualDensity.compact,
                          materialTapTargetSize:
                              MaterialTapTargetSize.shrinkWrap,
                        ...
                        child: ActionChip(
                          label: const Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 3),
                              Text('Filters', style: AppTextStyles.caption),
                            ],
                          ),
                          onPressed: _showFilterDialog,
                          visualDensity: VisualDensity.compact,
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // matchScore available for future use
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isGlass
                    ...
                    : (isDarkMode ? AppColors.darkCardSecondary : Colors.white),
                borderRadius: BorderRadius.circular(16),
                border: isGlass
                    ? Border.all(
              ...
              child: Row(
                children: [
                  ...
                  Stack(
                    children: [
                      !PhotoUrlHelper.isValidUrl(extendedProfile.photoUrl)
                          ? Container(
                              width: 64,
                              height: 64,
                              decoration: BoxDecoration(
