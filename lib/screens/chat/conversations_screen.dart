  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: const Icon(Icons.edit, color: AppColors.textPrimaryDark),
      ),
    );
  }
    ...
    return AppBar(
      ...
      title: Text(
        ...
        style: isDarkMode
            ...
            : AppTextStyles.displaySmallLight,
      ),
      actions: [
        IconButton(
          icon: Icon(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: isDarkMode
                        ...
                        : AppTextStyles.headlineMediumLight,
                  ),
            ...
            Stack(
              children: [
                CircleAvatar(
                  radius: 28,
                  backgroundImage:
                      PhotoUrlHelper.isValidUrl(displayPhoto) &&
