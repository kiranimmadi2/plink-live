...
class DatabaseCleanupService {
  ...
  Future<void> _deleteOldCollections() async {
    try {
      debugPrint('🗑️ Deleting old collections...');
      ...
      debugPrint('⚠️ Error deleting old collections: $e');
    }
  }
  ...
  Future<void> _deleteCollection(String collectionName) async {
    try {
      debugPrint('🗑️ Deleting collection: $collectionName');
      ...
      if (snapshot.docs.isEmpty) {
        debugPrint('✅ Collection $collectionName is already empty or doesn\'t exist');
        return;
      }
  ...
  Future<void> _cleanupOrphanedData() async {
    try {
      ...
      debugPrint('⚠️ Error cleaning orphaned data: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> getCleanupStatus() async {
    try {
      ...
      return {
        ...
        'oldCollectionsExist': userIntentsCount > 0 || intentsCount > 0 || processedIntentsCount > 0,
