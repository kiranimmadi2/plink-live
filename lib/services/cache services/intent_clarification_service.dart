...
class IntentClarificationService {
  ...
  Future<Map<String, dynamic>> generateClarifyingQuestions(
    String userInput,
  ) async {
    try {
      final prompt =
...
''';
      ...
      try {
        ...
        return {'success': true, 'data': _getFallbackQuestions(userInput)};
      }
    } catch (e) {
...
''';
  ...
  Map<String, dynamic> _getFallbackQuestions(String userInput) {
    ...
    if (lowerInput.contains('iphone') ||
        lowerInput.contains('phone') ||
        lowerInput.contains('samsung') ||
    ...
    } else if (lowerInput.contains('job') ||
        lowerInput.contains('work') ||
        lowerInput.contains('hire') ||
        lowerInput.contains('employ')) {
      return {
        'questions': [
          {
            'id': 'q1',
    ...
    } else if (lowerInput.contains('car') ||
        lowerInput.contains('vehicle') ||
