          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _fps >= 55 ? Colors.green.withValues(alpha: 0.8) 
                                  : _fps >= 30 ? Colors.orange.withValues(alpha: 0.8)
...
mixin PerformanceAware<T extends StatefulWidget> on State<T> {
  ...
  void stopTimer(String name, {bool log = true}) {
    ...
    if (timer != null) {
      timer.stop();
      if (log) {
        debugPrint('${widget.runtimeType} - $name: ${timer.elapsedMilliseconds}ms');
      }
