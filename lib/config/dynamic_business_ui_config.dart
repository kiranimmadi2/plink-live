...
class DynamicUIConfig {
  ...
  static const _genericConfig = DynamicUIConfig(
    category: BusinessCategory.professional,
    profileTemplate: 'generic_template',
    profileSections: [
      ProfileSection.hero,
...
class CategoryTerminology {
  ...
  static CategoryTerminology getForCategory(BusinessCategory category) {
    switch (category) {
      ...
      case BusinessCategory.beautyWellness:
        return const CategoryTerminology(
          screenTitle: 'Salon & Spa',
          filter1Label: 'Treatments',
          filter1Icon: 'spa',
          filter2Label: 'Packages',
          filter2Icon: 'card_giftcard',
          emptyStateMessage: 'Start adding beauty treatments and spa packages',
        );

      case BusinessCategory.healthcare:
        return const CategoryTerminology(
          screenTitle: 'Medical & Wellness',
          filter1Label: 'Medical',
          filter1Icon: 'medical_services',
          filter2Label: 'Wellness',
          filter2Icon: 'healing',
          emptyStateMessage: 'Start adding medical services and wellness treatments',
        );

      case BusinessCategory.education:
        return const CategoryTerminology(
          screenTitle: 'Courses & Programs',
          filter1Label: 'Courses',
          filter1Icon: 'school',
          filter2Label: 'Programs',
          filter2Icon: 'class',
          emptyStateMessage: 'Start adding courses or programs',
        );

      case BusinessCategory.fitness:
        return const CategoryTerminology(
          screenTitle: 'Classes & Memberships',
          filter1Label: 'Classes',
          filter1Icon: 'fitness_center',
          filter2Label: 'Memberships',
          filter2Icon: 'card_membership',
          emptyStateMessage: 'Start adding classes or memberships',
        );

      case BusinessCategory.automotive:
        return const CategoryTerminology(
          screenTitle: 'Inventory & Services',
          filter1Label: 'Cars',
          filter1Icon: 'directions_car',
          filter2Label: 'Services',
          filter2Icon: 'build',
          emptyStateMessage: 'Start adding cars or services to your inventory',
        );

      case BusinessCategory.realEstate:
        return const CategoryTerminology(
          screenTitle: 'Listings & Rentals',
          filter1Label: 'For Sale',
          filter1Icon: 'apartment',
          filter2Label: 'For Rent',
          filter2Icon: 'real_estate_agent',
          emptyStateMessage: 'Start adding property listings and rentals',
        );

      case BusinessCategory.travelTourism:
        return const CategoryTerminology(
          screenTitle: 'Packages & Tours',
          filter1Label: 'Packages',
          filter1Icon: 'local_offer',
          filter2Label: 'Tours',
          filter2Icon: 'tour',
          emptyStateMessage: 'Start adding packages or tours',
        );

      case BusinessCategory.entertainment:
        return const CategoryTerminology(
          screenTitle: 'Events & Tickets',
          filter1Label: 'Events',
          filter1Icon: 'event',
          filter2Label: 'Tickets',
          filter2Icon: 'confirmation_number',
          emptyStateMessage: 'Start adding events or tickets',
        );

      case BusinessCategory.petServices:
        return const CategoryTerminology(
          screenTitle: 'Pet Care & Supplies',
          filter1Label: 'Services',
          filter1Icon: 'pets',
          filter2Label: 'Supplies',
          filter2Icon: 'shopping_basket',
          emptyStateMessage: 'Start adding pet care services and supplies',
        );

      case BusinessCategory.homeServices:
        return const CategoryTerminology(
          screenTitle: 'Home Maintenance',
          filter1Label: 'Services',
          filter1Icon: 'home_repair_service',
          filter2Label: 'Repairs',
          filter2Icon: 'handyman',
          emptyStateMessage: 'Start adding home maintenance services and repairs',
        );

      case BusinessCategory.technology:
        return const CategoryTerminology(
          screenTitle: 'Devices & Support',
          filter1Label: 'Devices',
          filter1Icon: 'devices',
          filter2Label: 'Support',
          filter2Icon: 'computer',
          emptyStateMessage: 'Start adding devices and support services',
        );

      case BusinessCategory.legal:
        return const CategoryTerminology(
          screenTitle: 'Legal Practice',
          filter1Label: 'Practice Areas',
          filter1Icon: 'gavel',
          filter2Label: 'Consultations',
          filter2Icon: 'description',
          emptyStateMessage: 'Start adding legal practice areas and consultations',
        );

      case BusinessCategory.professional:
        return const CategoryTerminology(
          screenTitle: 'Consulting & Advisory',
          filter1Label: 'Consulting',
          filter1Icon: 'business_center',
          filter2Label: 'Advisory',
          filter2Icon: 'lightbulb',
          emptyStateMessage: 'Start adding consulting and advisory services',
        );
      ...
      case BusinessCategory.artCreative:
        return const CategoryTerminology(
          ...
          emptyStateMessage: 'Start showcasing your creative work and commissions',
        );
      ...
      case BusinessCategory.construction:
        return const CategoryTerminology(
          ...
          emptyStateMessage: 'Start adding construction projects and contracting services',
        );
  ...
  static IconData _getIconFromString(String iconName) {
    switch (iconName) {
      ...
      case 'room_service': return Icons.room_service_outlined;
      ...
      case 'card_membership': return Icons.card_membership_outlined;
      ...
      case 'real_estate_agent': return Icons.real_estate_agent_outlined;
      case 'local_offer': return Icons.local_offer_outlined;
      case 'tour': return Icons.tour_outlined;
      ...
      case 'lightbulb': return Icons.lightbulb_outlined;
      case 'local_shipping': return Icons.local_shipping_outlined;
      case 'delivery_dining': return Icons.delivery_dining_outlined;
      case 'palette': return Icons.palette_outlined;
      case 'design_services': return Icons.design_services_outlined;
      ...
      case 'precision_manufacturing': return Icons.precision_manufacturing_outlined;
