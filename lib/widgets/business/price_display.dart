...
class PriceDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultPriceColor = priceColor ?? (isDarkMode ? Colors.white : Colors.black87);
    final defaultOriginalColor = originalPriceColor ?? (isDarkMode ? Colors.white38 : Colors.grey);
    final defaultDiscountColor = discountBadgeColor ?? const Color(0xFF00D67D);
...
class PriceRangeDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDarkMode = Theme.of(context).brightness == Brightness.dark;
    final textColor = color ?? (isDarkMode ? Colors.white : Colors.black87);
...
class FreeBadge extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final badgeColor = color ?? const Color(0xFF00D67D);
