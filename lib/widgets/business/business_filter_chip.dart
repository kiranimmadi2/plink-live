...
class BusinessFilterChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultSelectedColor = selectedColor ?? const Color(0xFF00D67D);
    final defaultUnselectedColor = unselectedColor ??
        (isDarkMode ? Colors.white.withValues(alpha: 0.08) : Colors.grey[100]!);
            ...
            if (iconWidget != null) ...[
              ...
              Icon(
                ...
                color: isSelected
                    ...
                    : (iconColor ?? (isDarkMode ? Colors.white54 : Colors.grey[600])),
              ),
              const SizedBox(width: 6),
            ],
