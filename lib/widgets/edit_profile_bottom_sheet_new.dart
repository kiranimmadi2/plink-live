...
class _EditProfileBottomSheetState extends State<EditProfileBottomSheet> {
  ...
  // Search controllers
  final _interestsSearchController = TextEditingController();
  final _connectionTypesSearchController = TextEditingController();
  ...
  void dispose() {
    ...
    _connectionTypesSearchController.dispose();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSection(
                        ...
                        searchController: _interestsSearchController,
                      ...
                      _buildSection(
                        ...
                        searchController: _connectionTypesSearchController,
                      ...
                      _buildSection(
                        ...
                        searchController: _activitiesSearchController,
  ...
  Widget _buildSection({
    ...
    final filteredAll = _filterItems(searchController.text, allItems);
    ...
    return Column(
      ...
      children: [
        ...
        // Show All Button / All Items
        if (!isExpanded) ...[
          TextButton.icon(
            onPressed: onExpandToggle,
            icon: const Icon(Icons.expand_more),
            label: Text('Show All ${allItems.length} Options'),
        ...
        OutlinedButton.icon(
          ...
          label: const Text('Can\'t find? Add custom +'),
